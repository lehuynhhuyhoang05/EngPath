  ...
  return (
    <Screen testID="today-screen">
      ...
      <View style={styles.mission}>
        ...
        <View style={styles.missionIcon}><Icon name="target" size={28} color={colors.white} /></View>
        ...
        <Button label="Bắt đầu nhiệm vụ" onPress={onLesson} tone="secondary" />
      </View>
...
const styles = StyleSheet.create({
  header: { minHeight: 72, flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm },
  headerCopy: { flex: 1 },
  eyebrow: { ...type.caption, color: colors.primary, letterSpacing: 0.8 },
  screenTitle: { ...type.title, color: colors.ink, marginTop: spacing.xs },
  profileButton: { width: 48, height: 48, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primarySoft },
  pressed: { opacity: 0.72 },
  mission: { borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.scrim, marginTop: spacing.lg, marginBottom: spacing.xl },
  missionTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  missionLabel: { ...type.caption, color: '#BCC9F8', letterSpacing: 0.8 },
  missionIcon: { width: 52, height: 52, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary, marginTop: spacing.lg },
  missionTitle: { ...type.title, color: colors.white, marginTop: spacing.md },
  missionBody: { ...type.body, color: '#CFD6E5', marginTop: spacing.xs },
  missionSteps: { marginVertical: spacing.md, gap: spacing.xs },
  step: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs },
  stepDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#91A6F8' },
  stepText: { ...type.caption, color: colors.white },
  sectionTitle: { ...type.heading, color: colors.ink, marginBottom: spacing.sm },
  actionRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.sm, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface },
  actionIcon: { width: 48, height: 48, borderRadius: radii.md, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primarySoft },
  actionTitle: { ...type.bodyStrong, color: colors.ink },
  actionMeta: { ...type.caption, color: colors.muted, marginTop: 2 },
  gentleStreak: { borderRadius: radii.lg, padding: spacing.md, backgroundColor: colors.surfaceMuted, marginTop: spacing.lg },
  ...
  examPrompt: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.sm, backgroundColor: colors.warningSoft, marginTop: spacing.sm },
  examIcon: { width: 48, height: 48, borderRadius: radii.md, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface },
  ...
  pathItem: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderWidth: 1, borderColor: colors.line, borderRadius: radii.lg, padding: spacing.sm, backgroundColor: colors.surface },
  pathIndex: { width: 40, height: 40, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  ...
  draftNote: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm, padding: spacing.md, borderRadius: radii.md, backgroundColor: colors.warningSoft, marginTop: spacing.lg },
  draftText: { ...type.caption, color: colors.inkSoft, flex: 1 },
  practiceHero: { borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line, marginTop: spacing.lg, marginBottom: spacing.xl },
  practiceHeroIcon: { width: 64, height: 64, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primarySoft, marginBottom: spacing.md },
  ...
  secondaryCard: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.md, backgroundColor: colors.surfaceMuted },
  examCard: { minHeight: 84, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.sm, backgroundColor: colors.warningSoft, marginTop: spacing.sm },
  gradeNote: { borderRadius: radii.md, padding: spacing.md, backgroundColor: colors.surfaceMuted, marginTop: spacing.sm },
  gradeNoteText: { ...type.caption, color: colors.muted },
  stats: { flexDirection: 'row', gap: spacing.xs, marginVertical: spacing.xl },
  stat: { flex: 1, minHeight: 96, borderRadius: radii.lg, padding: spacing.sm, justifyContent: 'flex-end', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  statValue: { fontSize: 21, lineHeight: 27, fontWeight: '700', color: colors.ink },
  statLabel: { ...type.caption, color: colors.muted, marginTop: 2 },
  progressList: { borderWidth: 1, borderColor: colors.line, borderRadius: radii.lg, overflow: 'hidden', backgroundColor: colors.surface },
  ...
  examLargeIcon: { width: 68, height: 68, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.warningSoft },
  examStatus: { borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.scrim },
  examStatusTitle: { ...type.heading, color: colors.white, marginTop: spacing.md },
  examStatusBody: { ...type.body, color: '#CFD6E5', marginTop: spacing.xs },
  previewList: { marginTop: spacing.lg, gap: spacing.sm },
  previewRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.sm, backgroundColor: colors.surface },
  profileCard: { flexDirection: 'row', alignItems: 'center', gap: spacing.md, borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.scrim },
  profileAvatar: { width: 64, height: 64, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primary },
  profileAvatarText: { color: colors.white, fontSize: 26, fontWeight: '700' },
  profileLabel: { ...type.caption, color: '#BCC9F8' },
  profileGoal: { ...type.bodyStrong, color: colors.white, marginTop: spacing.xs, maxWidth: 230 },
  privacyCard: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.md, backgroundColor: colors.successSoft, marginTop: spacing.md },
