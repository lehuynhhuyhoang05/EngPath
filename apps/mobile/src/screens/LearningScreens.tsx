...
const styles = StyleSheet.create({
  ...
  ruleCard: { borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.scrim, marginVertical: spacing.xl },
  ruleIcon: { width: 48, height: 48, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.primarySoft },
  ruleLabel: { ...type.caption, color: '#BCC9F8', marginTop: spacing.md, letterSpacing: 0.8 },
  ruleText: { ...type.bodyStrong, color: colors.white, marginTop: spacing.xs },
  example: { borderRadius: radii.md, padding: spacing.md, backgroundColor: '#232E45', marginTop: spacing.md },
  exampleLabel: { ...type.caption, color: '#BCC9F8' },
  exampleText: { ...type.bodyStrong, color: colors.white, marginTop: spacing.xs },
  exampleVi: { ...type.caption, color: '#CFD6E5', marginTop: 2 },
  question: { ...type.heading, color: colors.ink, marginTop: spacing.xs, marginBottom: spacing.md },
  answers: { gap: spacing.sm },
  answer: { minHeight: 60, flexDirection: 'row', alignItems: 'center', gap: spacing.sm, padding: spacing.sm, borderWidth: 1, borderColor: colors.line, borderRadius: radii.lg, backgroundColor: colors.surface },
  ...
  feedback: { borderRadius: radii.lg, padding: spacing.md, marginTop: spacing.md },
  ...
  speechCard: { alignItems: 'center', borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.line },
  listenButton: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: spacing.xs, paddingHorizontal: spacing.md, borderRadius: radii.round, backgroundColor: colors.primarySoft },
  ...
  tipCard: { flexDirection: 'row', alignItems: 'flex-start', gap: spacing.sm, borderRadius: radii.lg, padding: spacing.md, backgroundColor: colors.warningSoft, marginTop: spacing.md },
  tipIcon: { width: 44, height: 44, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface },
  tipTitle: { ...type.label, color: colors.warning },
  tipBody: { ...type.body, color: colors.inkSoft, marginTop: 2 },
  recordState: { minHeight: 150, alignItems: 'center', justifyContent: 'center', borderRadius: radii.hero, backgroundColor: colors.primarySoft, marginTop: spacing.md, padding: spacing.lg },
  ...
  reviewCard: { alignItems: 'center', borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.primarySoft, marginTop: spacing.md },
  ...
  resultCard: { borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.successSoft, marginTop: spacing.md },
  resultTop: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm },
  resultIcon: { width: 52, height: 52, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface },
  ...
  deniedCard: { alignItems: 'center', borderRadius: radii.hero, padding: spacing.lg, backgroundColor: colors.dangerSoft, marginTop: spacing.md },
